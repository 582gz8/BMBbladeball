...
local Window = Fluent:CreateWindow({
	Title = "BMB HUB one click blade ball",
	SubTitle = "by beomayba/ https://discord.gg/xK75j33PeW",
	TabWidth = 160,
...
local Tabs = {
	Main = Window:AddTab({ Title = "Main", Icon = "rbxassetid://738491021" }),
	farmsettings = Window:AddTab({ Title = "Farm Settings", Icon = "rbxassetid://738491021" }),
	Settings = Window:AddTab({ Title = "GUI Settings", Icon = "settings" })
}
local rubyhub = {
	autoparrying = false,
...
local autoexplosion = Tabs.Main:AddToggle("autoexplosion", {Title = "Auto random Explosion", Default = false })
...
local autosword = Tabs.Main:AddToggle("autosword", {Title = "Auto random sword", Default = false })
...
local autovoteffa = Tabs.Main:AddToggle("autovoteffa", {Title = "Auto Vote for classic", Default = false })
...
local skipcasec = Tabs.Main:AddToggle("skipcasec", {Title = "Case NO CD", Default = false })
...
ImageButton.BackgroundColor3 = Color3.fromRGB(16, 224, 224)
...
InterfaceManager:SetFolder("BMB HUB")
